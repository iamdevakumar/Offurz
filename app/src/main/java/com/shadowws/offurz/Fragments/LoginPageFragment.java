 ...
 */
public class LoginPageFragment extends Fragment implements TabLayout.OnTabSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View LoginView = inflater.inflate(R.layout.fragment_login_page, container, false);
        tabLayout = (TabLayout) LoginView.findViewById(R.id.tabLayout);
        ...
        transaction.replace(R.id.login_container_layout, new LoginBuyerFragment());
        transaction.commit();
        viewPager = (ViewPager)LoginView.findViewById(R.id.pager);
...
//        }
    ...
    public void onTabSelected(TabLayout.Tab tab) {
        ...
        if(tab.getPosition() == 0){
            Log.d("Shared","buyer");
            Log.d("shared",pref.getString("type",""));
            FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
            FragmentTransaction transaction = fragmentManager.beginTransaction();
            transaction.replace(R.id.login_container_layout, new LoginBuyerFragment());
            transaction.commit();
            ...
            FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
            FragmentTransaction transaction = fragmentManager.beginTransaction();
            transaction.replace(R.id.login_container_layout, new LoginSellerFragment());
            transaction.commit();
        }
