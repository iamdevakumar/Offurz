 ...
 * {@link ApprovalNoFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ApprovalNoFragment#newInstance} factory method to
...
public class ApprovalNoFragment extends Fragment {
     ...
     * @return A new instance of fragment ApprovalNoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ApprovalNoFragment newInstance(String param1, String param2) {
        ApprovalNoFragment fragment = new ApprovalNoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_approval_no, container, false);
    }
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                    ...
                    else
                    {
                        ...
                        ft.replace(R.id.main_container, new ApprovalNoFragment());
                        ft.commit();
                    }
//                FragmentTransaction ft = getFragmentManager().beginTransaction();
