 ...
 * {@link NewLaunchProducts.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NewLaunchProducts#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NewLaunchProducts extends Fragment {
     ...
     * @return A new instance of fragment NewLaunchProducts.
     */
    // TODO: Rename and change types and number of parameters
    public static NewLaunchProducts newInstance(String param1, String param2) {
        NewLaunchProducts fragment = new NewLaunchProducts();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View newLaunchProductView = inflater.inflate(R.layout.fragment_new_launch_products, container, false);
        //NewLaunchProductsGet("http://logistic.shadowws.in/newupdation_an.php");
        NewLaunchProductsGet("http://offurz.com/newupdation_an.php");

        mRecyclerView = (RecyclerView) newLaunchProductView.findViewById(R.id.newLaunchProducts_recyler);
        sv = (SearchView)newLaunchProductView.findViewById(R.id.search_product);
        return newLaunchProductView;
    }
...
//        }
    ...
    public void NewLaunchProductsGet(String url) {
              ...
              // Toast.makeText(getContext(), " Result" + response.toString(), Toast.LENGTH_LONG).show();
                try {
                    ...
                    else
                    {
                        ...
                        transaction.replace(R.id.buyer_main_container, new EmptyData()).addToBackStack(null);
                        transaction.commit();
...
//                    }
            ...
            public void onErrorResponse(VolleyError error) {
              ...
              //  Toast.makeText(getContext(), "error" + error.toString(), Toast.LENGTH_LONG).show();
                Log.d("NewLaunch",error.toString());
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                    ...
                    else
                    {
                        ...
                        ft.replace(R.id.home_container_layout, new NewLaunchProducts());
                        ft.commit();
                    }
//                FragmentTransaction ft = getFragmentManager().beginTransaction();
