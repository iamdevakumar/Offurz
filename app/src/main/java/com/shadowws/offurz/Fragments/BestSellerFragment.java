 ...
 * {@link BestSellerFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link BestSellerFragment#newInstance} factory method to
...
public class BestSellerFragment extends Fragment {
    ...
    static String TAG = "BestSellerFrg";
    ...
    public static BestSellerFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG,"BestSeller");
        View bestSellerView = inflater.inflate(R.layout.fragment_best_seller, container, false);
       // BestSellerGet("http://logistic.shadowws.in/bestseller_an.php");
        BestSellerGet("http://offurz.com/bestseller_an.php");

        mRecyclerView = (RecyclerView) bestSellerView.findViewById(R.id.bestSeller_recyler);
        sv = (SearchView)bestSellerView.findViewById(R.id.search_product);
...
//        }
    ...
    public void BestSellerGet(String url) {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                    ...
                    else
                    {
                        ...
                        ft.replace(R.id.home_container_layout, new BestSellerFragment());
                        ft.commit();
                    }
//                FragmentTransaction ft = getFragmentManager().beginTransaction();
