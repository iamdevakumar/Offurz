 ...
 * {@link EmptyData.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link EmptyData#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EmptyData extends Fragment {
    ...
    public static EmptyData newInstance(String param1, String param2) {
        EmptyData fragment = new EmptyData();
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                    ...
                    else
                    {
                        ...
                        ft.replace(R.id.buyer_main_container, new EmptyData());
                        ft.commit();
                    }
//                FragmentTransaction ft = getFragmentManager().beginTransaction();
