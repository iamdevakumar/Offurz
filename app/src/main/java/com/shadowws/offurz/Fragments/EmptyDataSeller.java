 ...
 * {@link EmptyDataSeller.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link EmptyDataSeller#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EmptyDataSeller extends Fragment {
     ...
     * @return A new instance of fragment EmptyDataSeller.
     */
    // TODO: Rename and change types and number of parameters
    public static EmptyDataSeller newInstance(String param1, String param2) {
        EmptyDataSeller fragment = new EmptyDataSeller();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_empty_data_seller, container, false);
    }
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                    ...
                    else
                    {
                        ...
                        ft.replace(R.id.main_container, new EmptyDataSeller());
                        ft.commit();
                    }
//                FragmentTransaction ft = getFragmentManager().beginTransaction();
