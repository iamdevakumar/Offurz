 ...
 * {@link AboutUsBuyer.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AboutUsBuyer#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AboutUsBuyer extends Fragment {
     ...
     * @return A new instance of fragment AboutUsBuyer.
     */
    // TODO: Rename and change types and number of parameters
    public static AboutUsBuyer newInstance(String param1, String param2) {
        AboutUsBuyer fragment = new AboutUsBuyer();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_about_us_buyer, container, false);
    }
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                    ...
                    else
                    {
                        ...
                        ft.replace(R.id.home_container_layout, new AboutUsBuyer());
                        ft.commit();
                    }
//                FragmentTransaction ft = getFragmentManager().beginTransaction();
