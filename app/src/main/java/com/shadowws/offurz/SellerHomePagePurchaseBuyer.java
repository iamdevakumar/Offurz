...
import com.shadowws.offurz.Fragments.EmptyData;
 ...
 * {@link SellerHomePagePurchaseBuyer.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SellerHomePagePurchaseBuyer#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SellerHomePagePurchaseBuyer extends Fragment {
    ...
    public SellerHomePagePurchaseBuyer() {
     ...
     * @return A new instance of fragment SellerHomePagePurchaseBuyer.
     */
    // TODO: Rename and change types and number of parameters
    public static SellerHomePagePurchaseBuyer newInstance(String param1, String param2) {
        SellerHomePagePurchaseBuyer fragment = new SellerHomePagePurchaseBuyer();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View purchaseBuyerDetails = inflater.inflate(R.layout.fragment_seller_home_page_purchase_buyer, container, false);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    else
                    {
                        ...
                        fragmentTransaction.replace(R.id.main_container, new EmptyData());
...
//                                    System.exit(0);
                            ...
                            editor.clear();
                            editor.commit();
                            SharedPreferences walletPreference = getActivity().getSharedPreferences("sellerData", Context.MODE_PRIVATE);
